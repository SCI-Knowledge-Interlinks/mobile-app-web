    ...
    <View style={styles.screen}>
      ...
      <View style={styles.content}>
        <Card style={styles.messageCard}>
          <Text style={styles.messageTitle}>Hub features coming soon</Text>
          <Text style={styles.messageText}>We are preparing event tools and updates for this space.</Text>
        </Card>
      </View>
    </View>
  );
