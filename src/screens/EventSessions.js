    ...
    <View style={styles.screen}>
      ...
      <View style={styles.content}>
        <Card style={styles.messageCard}>
          <Text style={styles.messageTitle}>Session features coming soon</Text>
          <Text style={styles.messageText}>Schedules, tracks, and session details will appear here.</Text>
        </Card>
      </View>
    </View>
  );
